#Problem A
setwd("D://ACADGILD//VISUALIZATION AND PLOTTING//INPUT")
...
#Problem C
#Note: The Link provided in the assignment document is not an Online link. Using titanicic_train dataset.
library(titanic)
library(mice)
